    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<ProductDto, Product>()
              .ConvertUsing(src => new Product(src.Id, src.CategoryId, src.MenuId, src.Name, src.Description, src.ImageUrl, src.Price, (byte)src.Currency, src.DisplayOrder, src.IsActive, src.CreatedBy!));
